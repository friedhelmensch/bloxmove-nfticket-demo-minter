...
interface INFTicket {
    ...
    */
    ...
    function getTotalTicketPoolSize() external view returns (uint256);
    ...
    function getTicketBalance(uint256 ticketID) external view returns (uint256);

    function getTreasuryOwner() external returns (address);

    function getTicketProcessor() external returns (address);
    ...
    event WrongSender(address sender, address expectedSender, string message);
